...
![](octopus_can_bridge_setup/img/image001.png)
...
![](octopus_can_bridge_setup/img/image003.png)
...
![](octopus_can_bridge_setup/img/image005.png)

The processor model is labeled on the chip.

![](octopus_can_bridge_setup/img/image007.png)

Type: '*q*' then '*y*' to save.

![](octopus_can_bridge_setup/img/image009.png)

Type: '*make*' which compiles the firmware into a subdirectory called
'out'.

![](octopus_can_bridge_setup/img/image011.png)
...
![](octopus_can_bridge_setup/img/image013.png)
...
![](octopus_can_bridge_setup/img/image015.png)
...
![](octopus_can_bridge_setup/img/image017.png)

![](octopus_can_bridge_setup/img/image019.png)

![](octopus_can_bridge_setup/img/image021.png)

Back in CMD, make sure you are in the right directory. Type: *'cd
\~/CanBoot'*

![](/octopus_can_bridge_setup/img/image023.png)

Type: *'make clean'* followed by *'make menuconfig'*

![](octopus_can_bridge_setup/img/image025.png)
...
![](octopus_can_bridge_setup/img/image031.png)
...
![](octopus_can_bridge_setup/img/image033.png)
...
![](octopus_can_bridge_setup/img/image035.png)
Press and hold the reset button for at least five seconds to set the
Octopus to DFU mode.

![](octopus_can_bridge_setup/img/image037.png)
...
![](octopus_can_bridge_setup/img/image039.png)
...
![](octopus_can_bridge_setup/img/image041.png)
...
![](octopus_can_bridge_setup/img/image043.png)
...
![](octopus_can_bridge_setup/img/image049.png)
...
![](octopus_can_bridge_setup/img/image051.png)

**REMOVE** BOTH JUMPERS FROM 5V USB C AND BOOT0 PINS ON THE MCU

![](octopus_can_bridge_setup/img/image053.png)
...
![](octopus_can_bridge_setup/img/image055.png)
...
![](octopus_can_bridge_setup/img/image057.png)

Type: *'make'* to compile the Klipper firmware

![](octopus_can_bridge_setup/img/image059.png)
...
![](octopus_can_bridge_setup/img/image061.png)

Type: *'cd ..'* and *'ls -l'* to make sure renamed file exists in the
parent Klipper directory.

![](octopus_can_bridge_setup/img/image063.png)

Type: *'make clean'* and *'make menuconfig'* to repeat for the EBB36
board

![](octopus_can_bridge_setup/img/image065.png)

![](octopus_can_bridge_setup/img/image067.png)

Quit, Save, and type: *'make'* to generate another firmware for the
EBB42 board.

![](octopus_can_bridge_setup/img/image069.png)

Repeat previous steps to rename and move ebb_klipper .bin file to parent
Klipper directory.

![](octopus_can_bridge_setup/img/image071.png)

Type: *'make clean'*

![](octopus_can_bridge_setup/img/image073.png)
...
![](octopus_can_bridge_setup/img/image083.png)
...
![](octopus_can_bridge_setup/img/image085.png)
...
![](octopus_can_bridge_setup/img/image044.png)
